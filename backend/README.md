...
## Project Structure
    ...
    ├── testapiautoconnect_115860  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115860`
...
2. Clone this repo and `cd testapiautoconnect_115860`
